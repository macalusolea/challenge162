...
const deck = new (0, _deckJsDefault.default)(options).generateCards().shuffle().displayCards();
console.log(deck);
    ...
    generateCards() {
        this.values.forEach((value)=>{
            this.suits.forEach((suit)=>{
                this.#cards.push(new (0, _cardJsDefault.default)(value, suit));
            });
        });
        return this;
    }
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["hbj89","igcvL"], "igcvL", "parcelRequirefff1")
